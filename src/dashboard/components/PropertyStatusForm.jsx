// components/forms/PropertyStatusForm.tsx
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4" noValidate>
            <div>
                <Input
                    ...
                    placeholder={t('dashboard.propertyStatusForm.nameEnPlaceholder')}
            ...
            <div>
                <Input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    placeholder={t('dashboard.propertyStatusForm.nameArPlaceholder')}
            ...
            <div className="flex gap-3 justify-end pt-4 border-t border-neutral-400">
                ...
                <Button
                    ...
                    className="min-w-30"
                >
                    {item ? t('dashboard.propertyStatusForm.updateStatus') : t('dashboard.propertyStatusForm.createStatus')}
                </Button>
            </div>
        </form>
    );
